using KernelDensity, CellFitElectrolyte, PythonPlot, KDEDistributions, Distributions, ComponentArrays, CSV, DataFrames, Parameters, ProgressMeter, LinearAlgebra, OrdinaryDiffEq
...
@showprogress for n in 1:num_samples
    ...
    plot(df.times, predicted,"xkcd:grey", alpha=0.1)
end
