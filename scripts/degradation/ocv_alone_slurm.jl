...
mycellnumber = parse(Int,ENV["SLURM_ARRAY_TASK_ID"])
mycell = "VAH"*lpad(mycellnumber,2,"0")



for file in readdir("results/0302/")
    println(file)
    cell = split(file,"_")[1]
...
save(mycell*"_relaxation.jld2", capacity_dict)
